...
JOBS=(
    ...
    "deepseek-coder-instruct structured 11"
...
run_with_parallel() {
    ...
    echo "Logs will be saved to $LOG_FOLDER/$num.txt"
    CUDA_VISIBLE_DEVICES=$gpu python3 $cmd &>"$LOG_FOLDER/$num.txt"
    sleep 2
}
